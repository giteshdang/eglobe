import { GroupPeople, CreativeSvg, OutlineDashStaff, SubsCircleSvg, UserSvg, EmailSvg, EditSvg } from "../../assets/svg"
...
const Subscribe = (props)=>{
    return (
        <div className="w-screen md:h-screen relative px-8 md:px-0 md:py-0 flex items-center justify-center overflow-hidden contact--subscribe--section">
            ...
            <div className="md:grid-cols-5 items-center my-16 md:my-0  h-auto grid-cols-1 grid gap-16">
                <div className="flex col-span-1 md:col-span-2 md:pl-24 items-start space-y-2 flex-col ">
                    ...
                    <div className="flex mt-4 flex-row pl-4 pr-2 border py-2  rounded-md border-white bg-red-100" data-aos="flip-left"
     ...
     data-aos-duration="2000">
                        ...
                        <div className="flex mt-3 flex-row pl-4 pr-2 border py-2  rounded-md border-white bg-red-100" data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000">
                        ...
                        <div className="relative mt-3 items-start pl-4 pr-4 border py-2  rounded-md border-white bg-red-100" data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000">
                        ...
                        <div className="px-8 flex flex-col gap-4 md:px-12 py-12 md:py-24 bg-eglobe-green">
                            <div className="flex inter-regular text-white flex-row gap-2 items-start justify-start">
                                <div>
                                    ...
                                    className="w-12 h-12 object-fill" alt="" />
                                </div>
                                <div>Unit 2403, Tung Wai Commercial Building, 109-111 Gloucester Road, Wanchai, Hong Kong</div>
                            </div>
                            <div className="flex inter-regular text-white flex-row gap-2 items-start justify-start">
                                <div>
                                    <img src={phoneyellow} className="w-6 h-6 object-fill" alt="" />
                                </div>
                                <div>+1-978-489-8949</div>
                            </div>
                            <div className="flex inter-regular text-white flex-row gap-2 items-start justify-start">
                                <div>
                                    <img src={messageyellow}  className="w-6 h-6 object-fill"alt="" />
                                </div>
