...
import {
  ...
  const OurClient = (props) => {
    ...
    return (
        <div className="md:h-auto w-screen md:px-24 px-8 py-24 serv--client--section">
          <div className="flex flex-col space-y-2 items-center justify-center">
            ...
            <div className="client--logos">
              <img src={Agsl} alt="" />
              <img src={Anpers} alt="" />
              <img src={AuJardin} alt="" />
              <img src={Beekaboo} alt="" />
              <img src={Cilicon} alt="" />
              <img src={Fresh} alt="" />
              <img src={Godiva} alt="" />
              <img src={Lerivage} alt="" />
              <img src={PapaShark} alt="" />
              <img src={Respack} alt="" />
            </div>
