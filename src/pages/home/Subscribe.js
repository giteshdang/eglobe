        ...
        <div className="w-screen h-auto px-8 md:px-24 md:py-0 flex items-center justify-center my-16 md:my-0  overflow-hidden">
            ...
            <div className="col-span-1 relative w-full h-auto" >
                ...
                <div className="flex col-span-1 md:pl-24 items-start space-y-2 flex-col ">
                    ...
                    <div className="flex mt-4 flex-row pl-4 pr-2 border py-2  rounded-md border-white bg-red-100">
                        ...
                        <div className="flex mt-3 flex-row pl-4 pr-2 border py-2  rounded-md border-white bg-red-100">
                        ...
                        <div className="relative mt-3 items-start pl-4 pr-4 border py-2  rounded-md border-white bg-red-100">
