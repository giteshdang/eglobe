      ...
      <div className="flex-col hero-content lg:flex-row-reverse">
        ...
        <div className={`${css(styles.fadeInLeft)} flex-1 md:mt-0`}>
          <h1 className="tahoma-bold text-5xl">
            About <span className="text-eglobe-orange">E-Globe</span>
          </h1>
          <p className="inter-regular mb-2 mt-4 text-lg">
            As a global consulting company, our founders believe that the
            practice of giving back to society will promote change and progress
            across the world...
          </p>
        </div>
      </div>
