    ...
    return (
        <div className="md:h-auto w-screen md:px-24 px-8 py-24 ">
            ...
            <div className="flex flex-col items-start justify-start space-y-2 ">
                <img src={OutlineDashPortofolio} className="ml-2" alt="" data-aos="fade-up"
     data-aos-duration="3000"/>
                <h1 className="tahoma-bold text-5xl" data-aos="fade-up"
     data-aos-duration="3000">
                Our {" "}
                <span className="text-eglobe-orange">Client</span>
                </h1>
            </div>
            <div className="inter-regular text-base font-normal" data-aos="fade-up"
     data-aos-duration="3000">See how we’ve helped ambitious clients achieve extraordinary outcomes</div>
            <br />
            <br />
